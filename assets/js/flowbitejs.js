	...
	return (function () {
		...
		var t = {
				...
				853: function (t, e, i) {
					...
					function P(t) {
						return (
							t instanceof T(t).HTMLElement || t instanceof HTMLElement
						);
					}
					function C(t) {
						return (
					...
					function V(t, e, i) {
						...
						e &&
							P(t) &&
							((o =
								(t.offsetWidth > 0 && q(n.width) / t.offsetWidth) || 1),
							(r =
								(t.offsetHeight > 0 && q(n.height) / t.offsetHeight) ||
								1));
					...
					function ft(t, e) {
						...
						var n = pt(t),
							o =
								n === (null == (i = t.ownerDocument) ? void 0 : i.body),
							r = T(n),
							s = o
								? [r].concat(r.visualViewport || [], ut(n) ? n : [])
								: n,
							a = e.concat(s);
							...
							: ht(
									(function (t) {
										...
										return (
											"rtl" === R(o || i).direction &&
												(a +=
													D(i.clientWidth, o ? o.clientWidth : 0) -
													r),
							...
							if (k) {
								...
								if (p) {
									var ut,
										...
										_t = -1 !== [n, s].indexOf(E),
										bt =
											null != (ut = null == S ? void 0 : S[A])
												? ut
												: 0,
										wt = _t
											? vt
											: ht - T[gt] - j[gt] - bt + C.altAxis,
										Et = _t
											? ht + T[gt] + j[gt] - bt - C.altAxis
											: mt,
										Ot =
							...
							return (
								...
								(t.prototype.close = function (t) {
									...
									(e = n.triggerEl.classList).remove.apply(
										...
										(n.active = !1),
										n.iconEl &&
											n.iconEl.classList.remove("rotate-180"),
							...
							return (
								...
								(t.prototype._setActiveItem = function (t) {
									...
									this._indicators.length &&
										...
										(i =
											this._indicators[o].el.classList).remove.apply(
											i,
									...
									t.querySelectorAll("[data-carousel-item]").length &&
										Array.from(
											...
											r.push({ position: e, el: t }),
												"active" ===
													t.getAttribute("data-carousel-item") &&
													(s = e);
										});
									var a = [];
							...
							function (t, e, i) {
								if (i || 2 === arguments.length)
									for (var n, o = 0, r = e.length; o < r; o++)
										(!n && o in e) ||
											(n ||
												(n = Array.prototype.slice.call(e, 0, o)),
											(n[o] = e[o]));
